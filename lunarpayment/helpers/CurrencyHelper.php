...
class CurrencyHelper
{
	 ...
	 * @return int|number
	 */
	public static function getCurrencyMultiplier( $currency_iso_code ) {
		$currency = self::getCurrency( $currency_iso_code );
	...
	public static function getCurrency( $currency_iso_code ) {
		$currencies = array(
			'AED' =>
				array(
					'code'     => 'AED',
